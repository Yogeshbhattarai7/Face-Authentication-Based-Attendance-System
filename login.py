...
class Login:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"C:\Users\Ybhat\OneDrive\Desktop\Final year project\college_images\loginBg1.jpg")
    ...
    def login(self):
        if (self.txtuser.get()=="" or self.txtpwd.get()==""):
            ...
            conn = mysql.connector.connect(username="root", password="Mysql@ybh1",host="localhost",database="face_recognizer")
